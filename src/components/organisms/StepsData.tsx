...
const ReinforcementLearning = new Step({
  ...
  children:
    <Stack alignItems={'end'} justifyContent={'center'} width={'100%'} height={'100%'}>
      ...
      <Typography width={600}>
        در الگوی یادگیری تقویتی، کامپیوتر با دریافت پاداش و تاوان آموزش می‌بیند. در تعامل با یک محیط شبیه‌سازی شده و با قرار گرفتن در وضعیت‌های متفاوت، کامپیوتر تصمیم‌های پی‌در‌پی می‌گیرد و بر اساس نتیجه‌ی تصمیمات و پاداش و تاوان دریافتی از محیط، دانش خود را بهبود می‌بخشد. این الگو با موفقیت در ساخت عامل‌های هوشمند در بازی‌ها به کار رفته است و آینده‌ی بسیار امیدبخشی برای آن پیش‌بینی می‌شود.
      </Typography>
    ...
    <Stack alignItems={'end'} justifyContent={'center'} width={'100%'} height={'100%'}>
      ...
      <Stack direction={'row'} spacing={6}>
        ...
        <Stack alignItems={'end'}>
          ...
          <Typography width={600}>
            شبکه‌ی عصبی مصنوعی مدلی از یادگیری ماشین با الهام از ساختار مغز است. بین نورون‌های مغز انسان اتصالات پیچیده‌ای وجود دارد که امکان ذخیره‌سازی و پردازش اطلاعات را فراهم می‌کنند. به همین ترتیب در مدل شبکه‌ی عصبی نیز ساختاری پیچیده وجود دارد که از واحدهایی با نام مشابه تشکیل شده است و قدرت محاسباتی و یادگیری بالایی را به وجود می‌آورد. در شبکه‌های عصبی، اطلاعات به صورت ساختارمند از نورون‌های ورودی به نورون‌های خروجی جریان می‌یابد و طی این فرآیند، پردازش و تفسیر این اطلاعات صورت می‌پذیرد.
          </Typography>
          <Typography width={600}>
